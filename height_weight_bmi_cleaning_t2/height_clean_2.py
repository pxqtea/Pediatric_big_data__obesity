...
def height_cleaning(): 
    ...
    engine_local.execute('DROP TABLE IF EXISTS obesity_pangx_v27.heightconvert_zscore_flag')
    height_zscore_all.to_sql('heightconvert_zscore_flag', engine_local, index = False, schema = 'obesity_pangx_v27')
